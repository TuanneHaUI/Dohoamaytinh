...
void matban()
{
	...
	instance = model_mat_cpp * scale(vec3(1.2, 0.04, 0.6));
...
{
	mat4 instance = identity_mat4();
	instance = model_mat_cpp * scale(vec3(1.2, 0.6, 0.06));
	glUniformMatrix4fv(model_mat_location, 1, GL_FALSE, instance.m);
	glDrawArrays(GL_TRIANGLES, 0, 36);
...
{
	mat4 instance = identity_mat4();
	instance = model_mat_cpp * scale(vec3(0.06, 0.6, 0.6));
	glUniformMatrix4fv(model_mat_location, 1, GL_FALSE, instance.m);
	glDrawArrays(GL_TRIANGLES, 0, 36);
...
{
	mat4 instance = identity_mat4();
	instance = model_mat_cpp * scale(vec3(0.06, 0.8, 0.06));
	glUniformMatrix4fv(model_mat_location, 1, GL_FALSE, instance.m);
	glDrawArrays(GL_TRIANGLES, 0, 36);		
}
...
void DisplayFunc(void)
{
	...
	matban();
	model_mat_cpp = rotate_y(Alpha_2) * rotate_x(Alpha_1) * translate(vec3(T[0], T[1], T[2]))*translate(vec3(-0.57, -0.42, 0.28));
	chanban();
	model_mat_cpp = rotate_y(Alpha_2) * rotate_x(Alpha_1) * translate(vec3(T[0], T[1], T[2]))*translate(vec3(0.57, -0.42, 0.28));
	chanban();
	model_mat_cpp = rotate_y(Alpha_2) * rotate_x(Alpha_1) * translate(vec3(T[0], T[1], T[2]))*translate(vec3(-0.57, -0.42, -0.28));
	...
	model_mat_cpp = rotate_y(Alpha_2) * rotate_x(Alpha_1) * translate(vec3(T[0], T[1], T[2]))*translate(vec3(0.57, -0.42, -0.28));
	chanban();
	model_mat_cpp = rotate_y(Alpha_2) * rotate_x(Alpha_1) * translate(vec3(T[0], T[1], T[2]))*translate(vec3(0.57, -0.27, -0.01));
	matben();
	model_mat_cpp = rotate_y(Alpha_2) * rotate_x(Alpha_1) * translate(vec3(T[0], T[1], T[2]))*translate(vec3(-0.57, -0.27, -0.01));
	matben();
	model_mat_cpp = rotate_y(Alpha_2) * rotate_x(Alpha_1) * translate(vec3(T[0], T[1], T[2]))*translate(vec3(-0.0, -0.27, -0.28));
	mattruoc();
